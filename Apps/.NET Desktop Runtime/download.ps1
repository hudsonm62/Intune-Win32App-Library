...
param(
    [Parameter()]
    [uri]$URI = "https://builds.dotnet.microsoft.com/dotnet/WindowsDesktop/8.0.18/windowsdesktop-runtime-8.0.18-win-x64.exe",
    [Parameter()]
    [string]$OutFileName = "dotnet-desktop-runtime.exe"
)
