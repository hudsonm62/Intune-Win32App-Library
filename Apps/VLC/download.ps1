...
[CmdletBinding()]
param(
    # https://mirror.aarnet.edu.au/pub/videolan/vlc/?C=M;O=D
    [Parameter()]
    [uri]$URI = 'https://mirror.aarnet.edu.au/pub/videolan/vlc/3.0.21/win64/vlc-3.0.21-win64.exe',
    [Parameter()]
    [string]$OutFileName = 'vlc-installer.exe'
)
