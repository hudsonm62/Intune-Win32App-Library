...
$Locations = @(
    # User Locations
    [string](Join-path $env:LOCALAPPDATA "Audacity\Audacity.exe")

    # System Locations
    [string](Join-path $env:ProgramFiles "Audacity\Audacity.exe")
    [string](Join-path ${env:ProgramFiles(x86)} "Audacity\Audacity.exe")
)
#endregion
