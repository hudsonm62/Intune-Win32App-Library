...
$Locations = @(
    # User Locations
    [string](Join-path $env:LOCALAPPDATA "Smokeball\Smokeball.lnk")

    # System Locations
    [string](Join-path $env:ProgramFiles "Smokeball\Smokeball.lnk")
    [string](Join-path ${env:ProgramFiles(x86)} "Smokeball\Smokeball.lnk")
)
#endregion
