...
$AppName = "Foxit"
$Locations = @(
    [string](Join-path ${env:ProgramFiles(x86)} "Foxit Software\Foxit PDF Reader\FoxitPDFReader.exe")
    [string](Join-path $env:ProgramFiles "Foxit Software\Foxit PDF Reader\FoxitPDFReader.exe")
)
#endregion
