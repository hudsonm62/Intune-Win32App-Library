...
$Locations = @(
    # User Locations
    [string](Join-path $env:LOCALAPPDATA "Greenshot\Greenshot.exe")

    # System Locations - Broken as of Greenshot 1.3
    [string](Join-path ${env:ProgramFiles(x86)} "Greenshot\Greenshot.exe")
    [string](Join-path $env:ProgramFiles "Greenshot\Greenshot.exe")
)
#endregion
